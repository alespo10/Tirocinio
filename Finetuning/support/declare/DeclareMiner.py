...
from Finetuning.support.declare.Checkers import ConstraintChecker
...
class DeclareMiner(AbstractDiscovery, ABC):
    ...
    def __init__(self, log: D4PyEventLog, consider_vacuity: bool, min_support: float, max_support: float, itemsets_support: float = 0.9,
