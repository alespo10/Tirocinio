...
if std_evaluate:
    ...
    complete_sequences(model, tokenizer, evaluation_observation_list, test_set, completed_sequences_std_woc_output_file_path, verbose=verbose, avoid_cfls_calculation=avoid_cfls_calculation)
